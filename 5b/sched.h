...
/*
 * allows cpus and tasks to implement different scheduling policies.
 */
struct task_struct; /* workaround a chicken and egg problem */
struct sched_policy {
...
extern struct sched_policy **policy_of_cpu;
...
extern union aligned_sched_u aligned_data[];

#define cpu_curr(cpu) aligned_data[(cpu)].schedule_data.curr
#define last_schedule(cpu) aligned_data[(cpu)].schedule_data.last_schedule

#define IDLE_WEIGHT  (-1000)
